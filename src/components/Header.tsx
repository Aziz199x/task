...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-20 flex h-16 items-center justify-between border-b bg-background/95 px-4 backdrop-blur-sm" style={{ paddingTop: `env(safe-area-inset-top)` }}>
